...
@click.option("-t", "--threshold", default=4, prompt="Extraction threshold", help="Image intensity threshold used to extract contours.")
@click.option("-a", "--align", default=True, prompt="Align bbox", help="Align the bbox with the dominant dimension.")
